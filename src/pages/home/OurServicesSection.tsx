    ...
    return (
        <div className="flex flex-col items-center">
            <div className="flex justify-center self-stretch rounded-[60px] border-t border-solid border-blue-a100 bg-black-900 px-14 py-16 md:p-5">
                <div className="mb-1 flex w-[86%] flex-col items-center md:w-full">
                    <div className="flex items-start justify-end self-stretch md:flex-col">
                        ...
                        <div className="mt-[22px] flex w-[42%] rotate-[14deg] justify-end self-end md:w-full md:self-auto">
                            <div className="flex w-full flex-col items-end">
                                <Text size="text2x1" as="p" className="relative z-[2] font-buffalo font-normal text-white-a700">
                                    We care!
                                </Text>
                                <Img
                                    src="images/img_close_30x30.png"
                                    alt="Close Image"
                                    className="relative mr-[18px] mt-[-14px] h-[30px] w-[30px] object-cover md:mr-8"
                                />
                            </div>
                        </div>
                    </div>
            ...
            <div className="container-xs mt-3 flex flex-col items-center px-14 md:px-5 gap-y-24">
                ...
                <div className="flex gap-8 mx-auto max-w-7xl items-center">
                    <PricingCard
                        title="Starter"
                        price="$499"
                        billingCycle="Month"
